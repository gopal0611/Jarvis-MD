...
async function serialize(msg, message) {
  message.logger = {
    ...message.logger,
    info() {
      console.log();
  ...
  if (msg.message) {
    ...
    try {
      ...
      if (quoted&&quoted.quotedMessage) {
        ...
        msg.quoted.isSelf = msg.quoted.sender === message.user.id;
    ...
    message.client = msg;
    message.getFile = async (PATH, returnAsFilename) => {
      let res, filename;
     ...
     * @returns
     */
    message.sendImageAsSticker = async (jid, buff, options = {}) => {
      let buffer;
     ...
     * @returns
     */
    message.sendVideoAsSticker = async (jid, buff, options = {}) => {
      let buffer;
      if (options && (options.packname || options.author)) {
